    ...
    <div className="w-full h-screen overflow-y-auto flex items-center justify-center bg-white">
      {!role ? (
        ...
        <p className="text-lg text-gray-600 mb-8 leading-relaxed">
          Unlock the future of finance. Whether you&apos;re ready to invest in thriving businesses or launch your own, Infinity Fund is where innovation and opportunity collide.
        </p>
        ...
        <div className="w-full h-screen flex justify-center">
          <SignUp
            appearance={{
              elements: {
                card: "w-full h-full py-12 bg-white border-none shadow-none flex flex-col", // Full-width and height for the form
                form: "flex-grow flex flex-col justify-center", // Ensures content is centered within the card
                formButtonPrimary:
